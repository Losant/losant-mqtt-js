/**
 * This object facilitates all connections and communication with the
 * Structure platform. Most of the SDK logic is in this file.
 */
...
module.exports = function(options) {
  ...
  var structure = new events.EventEmitter();

  // Map of deviceId to device object.
  var devices = {};

  // Create the Device constructor. Wraps the underlying constructor so the
  // correct instance of structure can be passed through.
  structure.Device = function(options) {
  ...
  /**
   * Gets the device object from its id. If the device has not yet
   * been created, undefined will be returned.
   * deviceId: the id to get.
   */
  structure.getDevice = function(deviceId) {
